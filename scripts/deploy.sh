...
if [[ ${GITHUB_TOKEN} ]]  && [[ ${GITEE_TOKEN} ]]; then
    ...
    git push --force --quiet "https://kuzank:${GITHUB_TOKEN}@github.com/kuzank/kuzank-search.git" gh-pages
    git push --force --quiet "https://kuzank:${GITEE_TOKEN}@gitee.com/kuzank/kuzank-search.git" gh-pages
else
